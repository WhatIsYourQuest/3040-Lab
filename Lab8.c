...
TIM10->PSC = 0x02;                   //enable prescale register
...
void EXTI1_IRQHandler () 
{
  ...
  GPIOB->PUPDR |=  0x00005500;     //set bits 08-15 to 01 for PB4-PB7 pull-up resistors, *CHECK THIS STEP*
	...
	{
		key=1;
    TIM10->CCR1 = 800;           //makes it 10% PWM (8000 in decimal)
	}
	else if((pb4==0) && (pb1==0))  // button 2
	{
		key=2;
    TIM10->CCR1 = 1600;           //makes it 20% PWM (16000 in decimal)
	}
	else if((pb4==0) && (pb2==0))  // button 3
	{
		key=3;
    TIM10->CCR1 = 2400;           //makes it 30% PWM (24000 in decimal)
	}
	else if((pb5==0) && (pb0==0))  // button 4
	{
		key=4;
    TIM10->CCR1 = 3200;           //makes it 40% PWM (32000 in decimal)
	}
	else if((pb5==0) && (pb1==0))  // button 5
	{
		key=5;
    TIM10->CCR1 = 4000;           //makes it 50% PWM (4000 in decimal)
	}
	else if((pb5==0) && (pb2==0))  // button 6
	{
		key=6;
    TIM10->CCR1 = 4800;           //makes it 60% PWM (4800 in decimal)
	}
	else if((pb6==0) && (pb0==0))  // button 7
	{
		key=7;
    TIM10->CCR1 = 5600;           //makes it 70% PWM (5600 in decimal)
	}
	else if((pb6==0) && (pb1==0))  // button 8
	{
		key=8;
    TIM10->CCR1 = 6400;           //makes it 80% PWM (6400 in decimal)
	}
	else if((pb6==0) && (pb2==0))  // button 9
	{
		key=9;
    TIM10->CCR1 = 7200;           //makes it 90% PWM (7200 in decimal)
	}
	else if((pb4==0) && (pb3==0))  // button A
	{
		key=10;
    TIM10->CCR1 = 8000;           //makes it 100% PWM (8000 in decimal)
	}
